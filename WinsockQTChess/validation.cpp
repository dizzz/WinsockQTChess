...
int validation::validatePawn(Tile *temp) {
    ...
    if (row - 1 >= 0 && col - 1 >= 0) {
        if (tile[row - 1][col - 1]->pieceColor != temp->pieceColor &&
            tile[row - 1][col - 1]->piece) {
...
int validation::validateHorse(Tile *temp) {
    ...
    if (r - 2 >= 0 && c - 1 >= 0) {
        if (tile[r - 2][c - 1]->pieceColor != temp->pieceColor ||
            !tile[r - 2][c - 1]->piece) {
    ...
    if (r - 1 >= 0 && c - 2 >= 0) {
        if (tile[r - 1][c - 2]->pieceColor != temp->pieceColor ||
            !tile[r - 1][c - 2]->piece) {
...
int validation::validateKing(Tile *temp) {
    ...
    if (r - 1 >= 0) {
        if (!tile[r - 1][c]->piece ||
            tile[r - 1][c]->pieceColor != temp->pieceColor) {
    ...
    if (c - 1 >= 0) {
        if (!tile[r][c - 1]->piece ||
            tile[r][c - 1]->pieceColor != temp->pieceColor) {
    ...
    if (r - 1 >= 0 && c - 1 >= 0) {
        if (!tile[r - 1][c - 1]->piece ||
            tile[r - 1][c - 1]->pieceColor != temp->pieceColor) {
...
void validation::orange() {
    ...
    for (i = 0; i < max; i++)
        tile[Exp[i] / 8][Exp[i] % 8]->setStyleSheet(
